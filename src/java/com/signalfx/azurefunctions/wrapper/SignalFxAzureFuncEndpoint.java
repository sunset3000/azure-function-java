 ...
 * @author park
 */
public class SignalFxAzureFuncEndpoint implements SignalFxReceiverEndpoint {
    ...
    public SignalFxAzureFuncEndpoint(String hostname, int port) {
    ...
    public SignalFxAzureFuncEndpoint() {
